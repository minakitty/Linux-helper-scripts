...
#echo "${app}"
screen -dmS terranova java -server -Xms512M -Xmx4008M -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:+CMSIncrementalPacing -XX:ParallelGCThreads=4 -XX:+AggressiveOpts -jar /opt/minecraft/terranova/${app} nogui